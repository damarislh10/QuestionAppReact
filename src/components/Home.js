  ...
  render() {
    return <DivForm>
        <ContainerStyled>
            ...
            <Image src="https://www.pngkit.com/png/full/192-1923288_octocat-github-logo-transparent-octdrey-catburn.png" rounded width="250px" style={{ 
                textAlign: 'center'
            }}/>

            <Link to="/question" className="nav-link">
                Comienza el formulario aquì
            </Link>
        </ContainerStyled>
    </DivForm>
  }
